...
use crate::telemetry::spawn_blockign_with_tracing;
...
pub async fn publish_newsletter(
    ...
    let credentials = basic_authennication(request.headers()).map_err(PublishError::AuthError)?;
...
async fn validate_credentials(
    ...
    spawn_blockign_with_tracing(move || {
...
#[tracing::instrument(
    ...
    skip(expected_password_hash, password_cadidate)
)]
fn verify_password_hash(
    ...
    Argon2::default()
        .verify_password(
            password_cadidate.expose_secret().as_bytes(),
...
async fn get_stored_credentials(
    ...
    .fetch_optional(pool)
    .await
    .context("Failed to perfomr a query to retriee stored credentials.")?
